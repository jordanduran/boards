...
const WheelProductPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    wheel.id = wheelId;
    wheel.quantity = quantity;
    wheel.size = selectedSize;
    addToCart(wheel);
  ...
  useEffect(() => {
    if (wheel?.sizes?.length) {
      setSelectedSize(wheel?.sizes[0]);
    }
  }, [wheel]);
          ...
          <div className='lg:max-w-lg lg:self-end'>
            ...
            <section aria-labelledby='information-heading' className='mt-4'>
              ...
              <div className='mt-4 space-y-6'>
                <p className='text-base text-gray-500'>{wheel.description}</p>
              </div>
