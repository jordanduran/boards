...
const filters = [
  {
    ...
    name: 'Category',
    options: [
      { value: 'skateboard', label: 'Decks' },
      { value: 'complete', label: 'Complete Skateboards' },
...
const Filter = ({ selectedCategories, onSetSelectedCategories }) => {
  ...
  const handleSelectCategory = (e) => {
    ...
    if (!categories.includes(category)) {
      ...
      onSetSelectedCategories(categories);
            ...
            >
              <Dialog.Panel className='ml-auto relative max-w-xs w-full h-full bg-white shadow-xl py-4 pb-6 flex flex-col overflow-y-auto'>
                <div className='px-4 flex items-center justify-between'>
                  ...
                  <button
                    type='button'
                    className='-mr-2 w-10 h-10 bg-white p-2 rounded-md flex items-center justify-center text-gray-400 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-amber-500'
